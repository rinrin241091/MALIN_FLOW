        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="POST" action="{{ route('category.fonds.update', $fond->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            <label for="code">Mã định danh <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" class="form-control" rows="4">{{ old('description', $fond->description) }}</textarea>
                            @error('description')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
